					...
					{filteredShops.map((shop, index) => {
						...
						return (
							<div key={index} className="flex justify-center">
								<div className="overflow-hidden rounded-lg shadow-lg border bg-zinc-200 p-6 h-[500px] w-full flex flex-col transition-transform transform hover:scale-105 duration-300">
									...
									<div className="mt-4 text-center">
										<a
											...
											target="_blank"
											className="bg-green-500 text-white py-2 px-4 rounded-lg text-sm hover:bg-green-600 transition-colors duration-300"
