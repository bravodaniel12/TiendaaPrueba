...
function Start() {
	...
	return (
		...
		<div className="flex flex-col min-h-screen px-6 sm:px-10 md:px-16 lg:px-40 xl:px-60 pb-4">
		  ...
		  <div className="p-6">
			<p>
			  ...
			  non gravida lorem scelerisque. Duis ut fermentum libero. Etiam tincidunt libero ut ligula vehicula vehicula. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.
			</p>
			<p>
		  ...
		  <div className="flex-grow bg-[#f5f5f4] pt-1">
			<div className="py-4">
			  ...
			  <div className="grid sm:grid-cols-2 lg:grid-cols-3 xs:grid-cols-1 gap-8 place-content-between">
